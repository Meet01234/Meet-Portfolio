...
const Projects = () => {
  ...
  //     title: "AirGuide Tool",
  //     description:
  //       "The objective of this project is to develop an intuitive and effective AirGuide Tool and Presentation Tool for business meetings, allowing interactive navigation of business objectives without needing physical remotes.",
  //     technologies: ["Python"],
  //     highlights: [
  ...
  //     description:
  //       "Software application designed to streamline and automate banquet operations, providing a comprehensive solution to enhance customer journey, transaction, and booking process.",
  ...
  //     description:
  //       "Streamlined cloud-based infrastructure management using Chef and AWS for version-controlled infrastructure deployments through GitOps patterns.",
  ...
  //     description:
  //       "Deployed an Nginx-based web application inside Docker containers on AWS EC2 with Auto Scaling and Route 53 DNS integration.",
  ...
  //     description:
  //       "Built a real-time stock price server using Node.js and Redis, containerized with Docker for scalable deployment.",
  ...
  //     description:
  //       "Deployed WordPress and MySQL using Docker on an AWS EC2 instance with persistent data and container networking.",
  ...
  //     description:
  //       "Automated infrastructure configuration using Chef cookbooks and Git for version control and change tracking.",
  ...
  //     description:
  //       "A platform for secure and efficient handling of bank accounts, transactions, and customer services.",
  ...
  //     description:
  //       "Android application for company-specific aptitude test practice with instant feedback and personalized resources.",
  ...
  const projects = [
    ...
    //   title: "Bank Management System",
    //   description:
    //     "Banking software for managing customer accounts, transactions, and services with secure and user-friendly interfaces.",
    //   technologies: ["Python"],
    //   highlights: [
    ...
    //   title: "Aptitude Test and Preparation – QuizUp",
    //   description:
    //     "Android application for company-specific aptitude test preparation with instant feedback and customized study materials.",
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              {/* <div className="h-48 bg-secondary/70 flex items-center justify-center">
                <span className="font-mono text-2xl opacity-30">
                  Project {index + 1}
                </span>
              </div> */}
              <div>
