...
const Experience = () => {
  ...
  const experiences = [
    ...
    //   period: "Present",
    //   description:
    //     "Currently I am studying DevOps Engineering at University of Ahmedabad.",
    ...
    //   period: "Present",
    //   description:
    //     "Learning and implementing networking principles and technologies.",
    //   icon: <Network className="h-6 w-6" />,
    //   color: "bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400",
    // },
    {
      title: "DevOps & Networking Engineer",
      company: "Amar InfoTech",
      period: "Jan, 2025 - Present",
      description:
        "Currently, I am undergoing training and an internship at Amar InfoTech.",
      icon: <Network className="h-6 w-6" />,
      color: "bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400",
    },
  ];
        ...
        <div className="relative reveal-section">
          ...
          {experiences.map((exp, index) => (
            ...
            >
              {/* Timeline dot */}
              <div
                className={`absolute left-4 md:left-0 ${
        ...
        <div className="mt-20 reveal-section">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-4 rounded-lg glass-card interactive-card">
              ...
              <div className="flex justify-between items-start">
                <p className="text-muted-foreground text-sm mb-2">
                  Bhakta Kavi Narshinh Mehta University
                </p>
                <span className="text-sm text-muted-foreground px-2 py-0.5 rounded-full bg-secondary">
                  8.7 CGPA
                </span>
